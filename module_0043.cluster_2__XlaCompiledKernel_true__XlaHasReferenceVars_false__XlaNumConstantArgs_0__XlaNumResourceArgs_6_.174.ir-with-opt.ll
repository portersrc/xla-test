...
@buffer_for_constant_32 = local_unnamed_addr addrspace(1) constant [4 x i8] c"\00\00\80\FF", align 128
@shared_cache = private unnamed_addr addrspace(3) global [1 x [1 x [1 x float]]] undef
@buffer_for_constant_33 = local_unnamed_addr addrspace(1) constant [4 x i8] zeroinitializer, align 128
@shared_cache1 = private unnamed_addr addrspace(3) global [5 x [1 x [1 x float]]] undef
@buffer_for_constant_165 = local_unnamed_addr addrspace(1) constant [4 x i8] c" \00\00\00", align 128
@buffer_for_constant_162 = local_unnamed_addr addrspace(1) constant [4 x i8] c"\00\00\00B", align 128
