...
@buffer_for_constant_306 = external local_unnamed_addr addrspace(1) constant [4 x i8], align 128
@buffer_for_constant_151 = external local_unnamed_addr addrspace(1) constant [4 x i8], align 128
@buffer_for_constant_61 = external local_unnamed_addr addrspace(1) constant [4 x i8], align 128
@buffer_for_constant_60 = external local_unnamed_addr addrspace(1) constant [4 x i8], align 128
@shared_cache = external dso_local unnamed_addr addrspace(3) global [5 x [1 x [1 x float]]]
@shared_cache1 = external dso_local unnamed_addr addrspace(3) global [1 x [1 x [1 x float]]]
@shared_cache2 = external dso_local unnamed_addr addrspace(3) global [1 x [2 x [32 x [33 x float]]]]
...
__nv_powf.exit:                                   ; preds = %125, %__nv_isinff.exit23.i, %__nv_fabsf.exit19.i, %112, %__nv_fabsf.exit7.i
...
__nv_powf.exit31:                                 ; preds = %239, %__nv_isinff.exit23.i25, %__nv_fabsf.exit19.i24, %226, %__nv_fabsf.exit7.i18
...
common.ret:                                       ; preds = %reduction_write_output-true51, %reduction_write_output-after
  ret void
